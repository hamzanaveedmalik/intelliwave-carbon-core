        ...
        <div className="container relative mx-auto px-6 lg:px-8 z-10">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl mb-6">
              Custom Web Applications for Growing UK Businesses
            </h1>
            <p className="text-lg sm:text-xl text-white/90 mb-10 leading-relaxed">
              From concept to launch in 6 weeks. Fixed pricing, no surprises.
            </p>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Professional websites and web applications designed for UK
              businesses
            </p>
          </div>
